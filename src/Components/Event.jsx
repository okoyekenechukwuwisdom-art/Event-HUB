                ...
                <div className="grid gap-0 md:grid-cols-[1.1fr_0.9fr]">
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <div className="mt-5 space-y-3 text-sm">
                      ...
                      <div className={`flex items-center justify-between rounded-2xl  px-3 py-2.5 ${dark? 'bg-white': 'bg-slate-800' } `}>
                      ...
                      <div className={`flex items-center justify-between rounded-2xl  px-3 py-2.5 ${dark ? 'bg-white' : 'bg-slate-800'} `}>
                        <span className={`${dark ? 'text-slate-900' : ''}`}>Price</span>
                      ...
                      <div className="space-y-4 p-5">
                        ...
                        <div className="flex gap-3 pt-1">
                          ...
                          <button
                            ...
                            className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-amber-500 bg-amber-500 text-white shadow-lg shadow-amber-500/30 transition duration-200 hover:scale-105 hover:bg-amber-600 hover:shadow-xl hover:shadow-amber-500/40 focus:outline-none focus:ring-2 focus:ring-amber-300 cursor-pointer"
                          >
                          ...
                          <button
                            ...
                            className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-red-500 bg-red-500 text-white shadow-lg shadow-red-500/25 transition duration-200 hover:scale-105 hover:bg-red-600 hover:shadow-xl hover:shadow-red-500/35 focus:outline-none focus:ring-2 focus:ring-red-300 cursor-pointer"
                          >
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                              <path d="M3 6h18" />
                              <path d="M8 6V4h8v2" />
